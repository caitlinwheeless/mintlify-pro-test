...
description: Learn how to pull Langfuse LLM traces into Label Studio Enterprise and annotate them with a custom ReactCode UI.
duration: 10-15 mins
---
...
<div style={{textAlign: 'center', margin: '20px 0'}}>
  <img src="https://hs-sandbox-pub.s3.us-east-1.amazonaws.com/blogs-draft/tutorial-llm-reactcode-langfuse.png" alt="ReactCode 3-panel trace review UI for Langfuse" style={{maxWidth: '1000px', width: '100%', height: 'auto', border: '1px solid #ddd', borderRadius: '8px'}} />
</div>
...
- [Companion tutorials: Braintrust](how_to_review_braintrust_traces_with_label_studio) | [LangSmith](how_to_review_langsmith_traces_with_label_studio)
