...
description: Brief descriptions of all the options available when configuring the project settings
...
<Warning title="Starter Cloud">
If you see an Enterprise badge: <span className="badge"></span>
...
<dt id="task-limit">Task Limit (%) <span className="badge"></span></dt>
...
<dt id="annotation-limit">Tasks Per Annotator Limit <span className="badge"></span></dt>
...
<dt id="annotator-eval">Annotator Evaluation<span className="badge"></span></dt>
...
<dt id="task-agreement">Agreement <span className="badge"></span></dt>
...
<dt id="low-agreement">Low Agreement Resolution <span className="badge"></span></dt>
