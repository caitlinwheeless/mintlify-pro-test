...
description: For cases when you want to customize your Label Studio Kubernetes deployment, review these available Helm values that you can set in your Helm chart.
sidebarTitle: Available Helm values
parent: install_k8s
parent_enterprise: install_enterprise_k8s
---

{/* Style block for table formatting removed during Mintlify migration */}
