...
description: Sign up for Label Studio and invite users to collaborate on your data labeling, machine learning, and data science projects.
...
When you first [start Label Studio](start), you see the sign up screen.
