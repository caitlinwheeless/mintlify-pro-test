...
description: Set ground truth annotations in Label Studio Enterprise. 
sidebarTitle: Ground truth annotations
---
...
<img src="/images/review/iaa-popover.png" alt="" className="gif-border" style={{maxWidth: '705px'}} />
