...
description: Label Studio documentation for integrating the Label Studio frontend interface into your own machine learning or data labeling application workflow.
sidebarTitle: Frontend builds
---
...
<br />
<img src="/images/frontend/lsf-in-ls.jpg" className="gif-border" />
...
To see all the available options for the initialization of LabelStudio object, see the [Label Studio Frontend](frontend_reference).

<Accordion title="Using modern JS techniques (recommended)">
...
<Accordion title="Using plain HTML and JS">
...
<Accordion title="LSF with React">
...
Refer to the [Frontend Reference](frontend_reference) when developing with Label Studio Frontend.
