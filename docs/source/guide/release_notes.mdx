...
description: Review new features, enhancements, and bug fixes for on-premises Label Studio Enterprise installations.
---
...
<div className="release-note"><button className="release-note-toggle"></button>
<a name="2332md"></a>

## Label Studio Enterprise 2.33.2

<div className="onprem-highlight">Updates for SSO/SCIM, control ReactCode availability</div>
...
</div><div className="release-note"><button className="release-note-toggle"></button>
<a name="2331md"></a>

## Label Studio Enterprise 2.33.1

<div className="onprem-highlight">Bug fix for performance improvements</div>
...
<div className="onprem-highlight">Programmable interfaces with React, vectors, Databricks Service Principals, and stronger quality settings</div>
...
- **Resize panel widths in the template builder**
    ...
    <video style={{maxWidth: '600px'}} className="gif-border" autoplay loop muted>
...
* When you hover over an annotation tab in Quick View, you will now see metadata for the annotation. 
    ...
    <img src="/images/releases/2-33-tooltip.png" style={{maxWidth: '500px'}} alt="Screenshot" /> 
...
<div className="onprem-highlight">Bug fixes</div>
...
<div className="onprem-highlight">Support reports, granular permission options, new command palette</div>
...
<img src="/images/releases/2-32-command-palette.png" style={{maxWidth: '500px'}} alt="Screenshot" />
...
<img src="/images/releases/2-32-ann-eval-before.png" style={{maxWidth: '500px'}} alt="Screenshot" />

**After:**

<img src="/images/releases/2-32-ann-eval-after.png" style={{maxWidth: '500px'}} alt="Screenshot" />
...
<img src="/images/releases/2-32-task-summary-before.png" style={{maxWidth: '500px'}} alt="Screenshot" />

**After:**

<img src="/images/releases/2-32-task-summary-after.png" style={{maxWidth: '500px'}} alt="Screenshot" />
...
<img src="/images/releases/2-32-tabs-before.png" style={{maxWidth: '500px'}} alt="Screenshot" />

**After:**

<img src="/images/releases/2-32-tabs-after.png" style={{maxWidth: '500px'}} alt="Screenshot" />
...
- To better utilize space, the annotation ID and the navigation controls for the labeling stream have been moved to below the labeling interface.
    ...
    <img src="/images/releases/2-32-task-nav.png" style={{maxWidth: '500px'}} alt="Screenshot" />
...
<div className="onprem-highlight">Inline OCR labeling for PDFs, Markdown tag, better visibility into agreement and member performance</div>
...
<img src="/images/releases/2-31-markdown.png" style={{maxWidth: '500px'}} alt="Screenshot" />
...
<img src="/images/releases/2-31-agreement-selected.png" style={{maxWidth: '500px'}} alt="Screenshot" />
...
<img src="/images/releases/2-31-quality.png" style={{maxWidth: '650px'}} alt="Screenshot" />
...
<img src="/images/releases/2-31-delete.png" style={{maxWidth: '500px'}} alt="Screenshot" />
...
<div className="onprem-highlight">Databricks storage, Reviewer metrics, multiple UX enhancements</div>
...
<video style={{maxWidth: '800px'}} className="gif-border" autoplay loop muted>
...
<div className="onprem-highlight">New Chat tag, Azure Blob Storage with Service Principal authentication, filtering enhancements, improved UX</div>
...
<img style={{maxWidth: '825px'}} src="/images/releases/2-29-azure.png" alt="Screenshot"/>
...
<img style={{maxWidth: '800px'}} src="/images/releases/2-29-cloud-storage-modal.png" alt="Screenshot"/>
...
<img style={{maxWidth: '500px'}} src="/images/releases/2-29-debug-metrics.png" alt="Screenshot"/>
...
<img style={{maxWidth: '600px'}} src="/images/releases/2-29-dm-columns.png" alt="Screenshot"/>
...
<div className="onprem-highlight">Bitmasks, custom hotkeys, annotation summaries, project page improvements, and more</div>
...
<div className="onprem-highlight">Time series sync, new Multichannel tag for time series, spectrograms, playground 2.0, annotation result filtering</div>
...
<div className="onprem-highlight">Prompts on-prem availability, storage proxies, PDF tag, KeyPointLabels support, multi-task JSON imports for cloud</div>
...
<div className="onprem-highlight">Dark mode, new home page, annotator evaluation settings, plugins library, and multiple usability enhancements</div>
...
<img src="/images/releases/2-24-evaluation.png" style={{maxWidth: '600px', margin: '0 auto'}} alt="Screenshot of evaluation settings" />
...
<img src="/images/releases/2-24-ai-ticket.png" style={{maxWidth: '600px', margin: '0 auto'}} alt="Screenshot of AI assistant" />

#### Clear chat history in AI Assistant

You can now clear your chat history to start a new chat.

<img src="/images/releases/2-24-ai-new.png" style={{maxWidth: '600px', margin: '0 auto'}} alt="Screenshot of AI assistant" />
...
<img src="/images/releases/2-24-annotator-dashboard.png" style={{maxWidth: '600px', margin: '0 auto'}} alt="Screenshot of annotator dashboard button" />
...
<img src="/images/releases/2-24-drop-down.png" style={{maxWidth: '400px', margin: '0 auto'}} alt="Screenshot of annotator dashboard button" />
...
<div className="onprem-highlight">Google Cloud Storage WIF, drag-and-drop for video timelines, multiple security enhancements</div>
...
<div className="onprem-highlight">Bug fix</div>
...
<div className="onprem-highlight">Pause annotators, set annotation limits, new API tokens, deep linking for annotation and regions, usability improvements for audio</div>
...
<div className="onprem-highlight">Bulk labeling, enable AI features, and multiple labeling and Data Manager enhancements</div>
...
<div className="onprem-highlight">Security-related fixes</div>
...
<div className="onprem-highlight">Taxonomy for labeling, new audio hotkey, performance improvements, bug fixes </div>
...
<div className="onprem-highlight">Paginated multi-image labeling and a new Task Reservation setting </div>
...
<div className="onprem-highlight">Link comments to fields, export information from the Annotator Performance dashboard </div>
...
<div className="onprem-highlight">New reviewer workflow options, streamlined layout for the Projects page, and other UI improvements </div>
...
<div className="onprem-highlight">Video frame classification, user activation through SCIM, and bug fixes </div>
...
<div className="onprem-highlight">Reviewer workflow updates, drag-and-drop tab reordering, usability enhancements for the <b>Show region labels</b> option, and upgrading to Django 4.2 </div>
...
<div className="onprem-highlight">Refreshed interface for the HumanSignal platform and bug fixes</div>
...
<div className="onprem-highlight">Annotator performance dashboards, potential breaking change for Google Cloud Storage users, feature flag changes</div>
...
<div className="onprem-highlight">New experimental Cache Labels action in the Data Manager, annotation history in snapshots, new setting to restrict local imports into Label Studio, and changes to how the Hide Storage Settings for Manager environment variable works. </div>
...
<div className="onprem-highlight">Improved machine learning & LLM integrations, action to remove duplicated tasks, Redis ACL support, and other enhancements and bug fixes</div>
...
<div className="onprem-highlight">New ability to configure project-level roles, setting to hide the Cloud Storage page from Manager roles, other enhancements and bug fixes </div>
...
<div className="onprem-highlight">New <b>Reset Cache</b> action for projects, security update for activity logs, various bug fixes</div>
...
<div className="onprem-highlight">Granular API-level control over annotation history, UI enhancements for performance and user experience, security updates, bug fixes</div>
...
<div className="onprem-highlight">Improved webhook performance and various UI improvements</div>
...
<div className="onprem-highlight">Improved member list filtering from the Organization page, collapsible Ranker items, various UI improvements</div>
...
<div className="onprem-highlight">External taxonomy, group visibility in label distribution charts, soft delete users</div>
...
<div className="onprem-highlight">Improved label and review stream counter</div>
...
<div className="onprem-highlight">New <code>snap</code> parameter for KeyPoint, KeyPointLabels, Polygon, and PolygonLabels tags, improved usability when reviewing video in Outliner </div>
...
<div className="onprem-highlight">Security fix</div>
...
<div className="onprem-highlight">Project-level roles for SAML/SCIM, ability to pause annotation sessions</div>
...
<div className="onprem-highlight">Contextual scrolling for audio and video, search field on the Projects page, autocomplete prompt when editing the labeling configuration</div>
...
<div className="onprem-highlight">Draft column in the Data Manager</div>
...
<div className="onprem-highlight">New workspace actions, per-image classifications</div>
...
<div className="onprem-highlight">Enhanced UI for panels and tabs, new Ranker tag, new Outliner filter, async imports</div>
...
<div className="onprem-highlight">Updated content for empty project pages, UI changes for async export conversion</div>
...
<div className="onprem-highlight">Data Manager actions for reviewers, better placement for annotation instructions, allow email lists when inviting users</div>
...
<div className="onprem-highlight">Performance optimization for projects API, storage link resolver for nested task data fields</div>
...
<div className="onprem-highlight"><code>skipDuplicates</code> parameter for TextArea, audio v3 Web Audio alternative decoder option, S3 custom endpoint for persistent storage </div>
...
<div className="onprem-highlight">New <code>splitchannels</code> option on audio configs, keyboard shortcuts for the Data Manager, restore locked annotations</div>
...
<div className="onprem-highlight">Label placement change for regions, YOLO support for PolygonLabels</div>
...
<div className="onprem-highlight">Improved logging, API for project annotation history</div>
...
<div className="onprem-highlight">Audio player enhancements, comments and notifications improvements, support for numpad hotkeys</div>

This section highlights the new features and enhancements, and bug fixes in Label Studio Enterprise 2.4.

### New features and enhancements 
- The [Comments and Notifications](/guide/comments_notifications) feature allows you to discuss task issues and other problems during labeling and reviewing processes.
...
<div className="onprem-highlight">New helm chart, multiple usability enhancements, including new Data Manager columns and the ability to duplicate projects</div>
...
<div className="onprem-highlight">Dynamic Labels template, Comments column in the Data Manager, decommissioning MinIO</div>
...
<div className="onprem-highlight">Comment visibility, SCIM enhancements, Redis SSL support, notification center, drafts in Annotation History, new history types</div>
...
<div className="onprem-highlight">SCIM 2.0 support, rotating bounding boxes, 'Last updated by' column in the Data Manager, ability to navigate to the previous task </div>
...
- Starting with this release, as an annotator you can create a rotated bounding box with the "three point click" or "two point click" feature to annotate images.  
    ...
    <br />
    <div style={{margin: 'auto', textAlign: 'center'}}><img src="/images/two-point-click.png" style={{opacity: '0.8'}}/></div>
    <i>Figure 1: Two point click rectangle.</i>

    
    <br />
    <div style={{margin: 'auto', textAlign: 'center'}}><img src="/images/three-point-click.png" style={{opacity: '0.8'}}/></div>
...
- This release includes the `Last updated by` column in **Data Manager** with information of `updated_at` - `updated_by`, annotator/reviewer (the person who made the last modifications for any of the annotations in this task) at `updated_at` time.
    ...
    <br />
    <div style={{margin: 'auto', textAlign: 'center'}}><img src="/images/last-updated-by-column.png" style={{opacity: '0.8'}}/></div>
...
- This release introduces the go-back functionality (`<` icon) that allows you to navigate back to the previous task through the review stream.
    ...
    <br />
    <div style={{margin: 'auto', textAlign: 'center'}}><img src="/images/go-back-reviewstream.png" style={{opacity: '0.8'}}/></div>
...
- Starting with this release, you can create a **Lead Time** column in **Data Manager** with averaged lead time per task.
    ...
    <br />
    <div style={{margin: 'auto', textAlign: 'center'}}><img src="/images/lead-time.png" style={{opacity: '0.8'}}/></div>
