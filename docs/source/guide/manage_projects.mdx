...
description: A description of various project management actions available.
...
1. Click the overflow menu for the project and select **Duplicate project**:
    ...
    <img src="/images/project/project_menu_lse.png" style={{maxWidth: '500px'}} alt="Screenshot" />
