...
description: Create and evaluate an LLM prompt
sidebarTitle: Draft and run prompts
---
...
<br /><br />
<video src="../images/prompts/prompts.mp4" controls="controls" style={{maxWidth: '800px'}} className="gif-border" />
