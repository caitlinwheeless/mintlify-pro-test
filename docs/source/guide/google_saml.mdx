...
description: Label Studio Enterprise documentation for setting up Google as Identity Provider for SAML SSO Setup Example.
sidebarTitle: Google SAML SSO with Label Studio Setup Example
---
...
2. **Copy SAML configuration**
   - From the **Details for Identity Provider** section, copy the following URLs: 
    ...
    <img src="/images/google-saml/4-lse-saml.png" className="gif-border" />
...
1. **Access Google Admin Console:**
   ...
   - Go to **Directory** > **Groups**.
    ...
    <img src="/images/google-saml/9-add-group.png" className="gif-border" />

2. **Add a new group:**
   - Click **Create group** and follow the steps to create and save a new group. In this example, the group is named "TestGroup." 
 
    <img src="/images/google-saml/10-add-group-2.png" className="gif-border" />
...
3. **Assign users to the new group:**
   ...
   - Select **More options > Add selected users to groups**. 
    ...
    <img src="/images/google-saml/11-add-group-3.png" className="gif-border" />
...
1. **Access Google Admin console:**
   ...
   - Go to **Apps** > **Web and mobile apps**.
    ...
    <img src="/images/google-saml/1-web-apps.png" className="gif-border" />

2. **Add a new SAML app:**
   - Select **Add App > Add custom SAML app**.
   - Enter a name for the app (e.g. "Label Studio") and click **Continue**.

    <img src="/images/google-saml/2-add-app.png" className="gif-border" />
...
3. **Download IdP metadata:**
   - When given the option, download the IdP metadata file for your new app. This file contains all the necessary information to configure Label Studio.
    ...
    <img src="/images/google-saml/3-metadata.png" className="gif-border" />
...
4. **Configure SAML settings:**
   ...
   - Click **Continue**.
    ...
    <img src="/images/google-saml/5-acs-setup.png" className="gif-border" />
...
5. **Map attributes:**
   ...
   - Click **Finish**.
    ...
    <img src="/images/google-saml/6-atrributes-setup.png" className="gif-border" />
...
1. **Upload IdP Metadata:**
   ...
   - Upload the IdP metadata file you downloaded from Google Admin console.
    ...
    <img src="/images/google-saml/4-lse-saml-add-metadata.png" className="gif-border" />
...
2. **Map Groups and Roles:**
   - Set up group mappings to roles and workspaces as needed. Ensure the group names match those sent by Google in the SAML response.
    ...
    <img src="/images/google-saml/14-lse-saml-role-group.png" className="gif-border" />
...
1. **Return to the Google Admin console**:
   ...
   - Select the Label Studio app.
    ...
    <img src="/images/google-saml/12-assign-group-1.png" className="gif-border" />
...
2. **Assign the Label Studio application to the group:**
    ...
    <img src="/images/google-saml/13-assign-group-2.png" className="gif-border" />
...
<img src="/images/google-saml/15-lse-sso-login.png" className="gif-border" />
