...
description: Label Studio Enterprise documentation for setting up LDAP authentication for your data labeling, machine learning, and data science projects.
sidebarTitle: LDAP
parent: admin_auth
...
To more easily [manage access to Label Studio Enterprise](manage_users), you can map LDAP groups to both `roles` or `workspaces`. 
