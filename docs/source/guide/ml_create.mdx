...
description: Set up your machine learning model to output and consume predictions in your data science and data labeling projects. 
sidebarTitle: Write your own ML backend
---
...
3. Return a result in the [Label Studio predictions format](predictions#Format-pre-annotations-for-Label-Studio), which varies depending on the type of labeling being performed.
