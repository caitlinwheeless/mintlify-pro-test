...
description: Label Studio Enterprise documentation about how to add a custom agreement metric to use for assessing annotator agreement or the quality of your annotation and prediction results for data labeling and machine learning projects.
...
| --- | --- | --- |
| `annotation_1` | JSON object | The first annotation or prediction to compare when calculating agreement. Retrieved in [Label Studio JSON format](export#Label-Studio-JSON-format-of-annotated-tasks). |
| `annotation_2` | JSON object | The second annotation or prediction to compare when calculating agreement. Retrieved in [Label Studio JSON format](export#Label-Studio-JSON-format-of-annotated-tasks).
...
```
4. [Restart your Helm release](install_enterprise_k8s#Restart-Label-Studio-Enterprise-using-Helm).
...
5. [Restart your Helm release](install_enterprise_k8s#Restart-Label-Studio-Enterprise-using-Helm).
