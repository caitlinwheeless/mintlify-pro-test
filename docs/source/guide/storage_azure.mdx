...
description: "How to set up source and target storage for Microsoft Azure Blob storage."
sidebarTitle: Microsoft Azure
parent: storage
parent_enterprise: storage
---

Connect your [Microsoft Azure Blob storage](https://docs.microsoft.com/en-us/azure/storage/blobs/storage-blobs-introduction) container with Label Studio. For details about how Label Studio secures access to cloud storage, see [Secure access to cloud storage](security#Secure-access-to-cloud-storage).
...
Before you begin, review the information in [Cloud storage for projects](storage) and [Secure access to cloud storage](security#Secure-access-to-cloud-storage).
