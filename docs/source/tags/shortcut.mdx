---
title: Shortcut
description: Customize Label Studio to define keyboard shortcuts and hotkeys to accelerate labeling for machine learning and data science projects.
---

import Shortcut from "/docs/source/includes/tags/shortcut.mdx";
