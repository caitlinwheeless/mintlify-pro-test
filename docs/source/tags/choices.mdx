---
title: Choices
description: Customize Label Studio with multiple choice labels for machine learning and data science projects.
---

import Choices from "/docs/source/includes/tags/choices.mdx";
