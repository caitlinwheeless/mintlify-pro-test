---
title: Audio
description: Customize Label Studio with the Audio tag for advanced audio annotation tasks for machine learning and data science projects.
---

import Audio from "/docs/source/includes/tags/audio.mdx";
