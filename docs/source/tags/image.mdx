---
title: Image
description: Customize Label Studio with the Image tag to annotate images for computer vision machine learning and data science projects.
---

import Image from "/docs/source/includes/tags/image.mdx";
