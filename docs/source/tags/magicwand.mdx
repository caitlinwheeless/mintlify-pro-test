---
title: Magicwand
description: Customize Label Studio with a Magic Wand tag to quickly click and drag to threshold flood fill image areas during image segmentation labeling for machine learning and data science projects.
---

import Magicwand from "/docs/source/includes/tags/magicwand.mdx";
...
[Label Studio storage guide](../guide/storage#Troubleshoot-CORS-and-access-problems) for more
...
use Label Studio's signed URL support ([AWS](../guide/storage#Set-up-connection-in-the-Label-Studio-UI),
[GCP](../guide/storage#Set-up-connection-in-the-Label-Studio-UI-1), and
[Azure](../guide/storage#Set-up-connection-in-the-Label-Studio-UI-2)).
