...
type: tags
order: 440
meta_title: VideoVectorLabels Tag for Video Vector Label Annotation
meta_description: Customize Label Studio with the VideoVectorLabels tag for labeled vector annotation on video frames.
---

The `VideoVectorLabels` tag is used to create labeled vectors on video frames. 

Use with the following data types: video.

<video style="max-width: 800px;" class="gif-border" autoplay loop muted>
      <source src="/images/tags/videovector-opossum.mp4">
</video>
