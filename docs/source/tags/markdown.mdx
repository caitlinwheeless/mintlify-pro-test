---
title: Markdown
description: Customize Label Studio with the Markdown tag to display formatted markdown text content for machine learning and data science projects.
---

import View from "/docs/source/includes/tags/view.mdx";
