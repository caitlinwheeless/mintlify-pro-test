---
title: Paragraphs
description: Customize Label Studio with the Paragraphs tag to annotate paragraphs for NLP and NER machine learning and data science projects.
---

import Paragraphs from "/docs/source/includes/tags/paragraphs.mdx";
