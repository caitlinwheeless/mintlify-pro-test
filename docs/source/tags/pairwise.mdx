---
title: Pairwise
description: Customize Label Studio with the Pairwise tag for object comparison tasks for machine learning and data science projects.
---

import Pairwise from "/docs/source/includes/tags/pairwise.mdx";
