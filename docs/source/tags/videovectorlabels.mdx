...
description: Customize Label Studio with the VideoVectorLabels tag for labeled vector annotation on video frames.
---

import Vectorlabels from "/docs/source/includes/tags/vectorlabels.mdx";
