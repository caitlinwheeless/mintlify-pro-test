---
title: PDF
description: Label Studio PDF tag for loading PDF documents for machine learning and data science projects.
---

import Pdf from "/docs/source/includes/tags/pdf.mdx";
...
- Perform OCR validation on supported PDFs. <span className="badge"></span>
...
## Example: OCR <span className="badge"></span>
