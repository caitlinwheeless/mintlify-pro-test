---
title: Chat
description: Display and extend chat transcripts; optionally request assistant replies from an LLM. Supports message editing controls and min/max limits.
---

import Chat from "/docs/source/includes/tags/chat.mdx";
