---
title: Ellipse
description: Customize Label Studio with ellipse tags to add elliptical bounding boxes to images for machine learning and data science projects.
---

import Ellipse from "/docs/source/includes/tags/ellipse.mdx";
