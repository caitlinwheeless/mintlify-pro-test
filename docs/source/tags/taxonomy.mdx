---
title: Taxonomy
description: Customize Label Studio with the Taxonomy tag and use hierarchical labels for machine learning and data science projects.
---

import Taxonomy from "/docs/source/includes/tags/taxonomy.mdx";
