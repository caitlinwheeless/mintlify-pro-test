---
title: Rectangle
description: Customize Label Studio with the Rectangle tag to add rectangle bounding boxes to images for machine learning and data science projects.
---

import Rectangle from "/docs/source/includes/tags/rectangle.mdx";
