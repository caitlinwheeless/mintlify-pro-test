...
title: Visual Ranker
is_new: t
description: Template for creating a ranked dataset for text-to-image models with Label Studio for your machine learning and data science projects.
---

<img src="/images/templates/visual-ranker.png" alt="" className="gif-border" width="700px"/>
