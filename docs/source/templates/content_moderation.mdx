...
description: Template for performing content moderation labeling tasks.
---

<img src="/images/templates/content-moderation.png" alt="" className="gif-border" width="552px"  />
...
This displays the text that needs moderation. There are multiple ways to import text files. See the [Text tag documentation](/tags/text) and our [import documentation](/guide/tasks#Types-of-data-you-can-import-into-Label-Studio). 
