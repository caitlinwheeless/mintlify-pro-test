...
description: Template for ner tagging for invoices (bio format) with Label Studio
community: true
...
<img src="/images/templates/ner-tagging-invoices-bio-format.jpg" alt="" className="gif-border" width="552px" height="408px" />
