...
description: Label Studio Template library of data labeling and annotation configurations for various data types.
---
...
<a className="button" href="index.html">See all templates!</a>
