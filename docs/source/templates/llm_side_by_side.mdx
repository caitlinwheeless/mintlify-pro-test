...
is_new: t
description: Evaluate a side-by-side comparison of two LLM responses. 
---

<img src="/images/templates/side-by-side-comparison.png" alt="" className="gif-border" width="700px"/>
