...
is_new: t
description: Template for classifying frames within a video.
---

<img src="/images/templates/video-frame-classification.png" alt="" className="gif-border" width="552px" height="408px" />
...
## Related Tags
- [TimelineLabels](/tags/timelinelabels)
- [Video](/tags/video)
- [Label](/tags/label)
