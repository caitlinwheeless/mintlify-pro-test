...
description: Template for classifying medical images and using bounding boxes for image segmentation.
---


<img src="/images/templates/medical-image-classification.png" alt="" className="gif-border" width="552px" height="408px" />
