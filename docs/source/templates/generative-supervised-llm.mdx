...
is_new: t
description: Template for creating dataset for supervised LLM fine-tuning with Label Studio for your machine learning and data science projects.
---

<img src="/images/templates/generative-supervised-llm.png" alt="" className="gif-border" width="700px"/>
