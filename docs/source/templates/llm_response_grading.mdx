...
is_new: t
description:  Assigning a grade to LLM responses based on how well it meets your internal guidelines. 
---

<img src="/images/templates/response-grading.png" alt="" className="gif-border" width="700px"/>
