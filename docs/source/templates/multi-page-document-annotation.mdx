...
description: Template for labeling large, multi-page documents more easily and efficiently.
---

<img src="/images/templates/multipage.png" alt="" className="gif-border" />
