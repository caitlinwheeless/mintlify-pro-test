...
title: RAG Retrieval
is_new: t
description: Create a ranked dataset for building a RAG system for LLMs with Label Studio for your machine learning and data science projects.
---

<img src="/images/templates/llm-ranker.png" alt="" className="gif-border" width="700px" />
