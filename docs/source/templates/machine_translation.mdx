...
description: Template for providing translations of text with Label Studio for your machine learning and data science projects.
---

<img src="/images/templates/machine-translation.png" alt="" className="gif-border" width="552px" height="408px" />
