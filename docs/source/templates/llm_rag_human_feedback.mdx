...
is_new: t
description: Evaluate the contextual relevancy of retrieved documents and rate the LLM response. 
---

<img src="/images/templates/evaluate-rag-human-feedback.png" alt="" className="gif-border" width="700px"/>
