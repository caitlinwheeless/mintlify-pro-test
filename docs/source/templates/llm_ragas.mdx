...
is_new: t
description: Use Ragas metrics to evaluation LLM responses. 
---

<img src="/images/templates/evaluate-rag-automated-metrics.png" alt="" className="gif-border" width="700px"/>
