...
You can add a [header](/tags/header) to provide instructions to the
annotator:
...
Use the [Image](/tags/image) object tag to specify the image data and allow
...
Use the [VectorLabels](/tags/vectorlabels) control tag to allow annotators
...
arguments. Use the `background` argument with the [Label](/tags/label)
...
- [Header](/tags/header)
- [Image](/tags/image)
- [VectorLabels](/tags/vectorlabels)
- [Label](/tags/label)
