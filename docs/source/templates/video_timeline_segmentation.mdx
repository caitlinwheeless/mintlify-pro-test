...
description: Template for segmenting videos on a timeline with Label Studio for your machine learning and data science projects.
---

<img src="/images/templates/video-timeline-segmentation.png" alt="" className="gif-border" width="552px" height="408px" />
