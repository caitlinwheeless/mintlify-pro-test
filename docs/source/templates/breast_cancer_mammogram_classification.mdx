...
description: Template for breast cancer mammogram classification with Label Studio
community: true
...
<img src="/images/templates/breast-cancer-mammogram-classification.jpg" alt="" className="gif-border" width="552px" height="408px" />
