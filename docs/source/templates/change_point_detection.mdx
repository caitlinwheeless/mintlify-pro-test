...
description: Template for labeling change point detection in time series data with Label Studio for your machine learning and data science projects.
---

<img src="/images/templates/change-point-detection.png" alt="" className="gif-border" width="552px" height="408px" />
...
Use the [TimeSeriesLabels](/tags/timeserieslabels) control tag to allow annotators to label the region indicating change on the time series graph:
```xml
    <TimeSeriesLabels name="label" toName="ts">
        <Label value="Change" background="red" />
    </TimeSeriesLabels>
