...
description: Template for monitoring and evaluating chat conversations.
---

<img src="/images/templates/chat-red-team-exercises.png" alt="" className="gif-border" style={{maxWidth: '552px'}} />
