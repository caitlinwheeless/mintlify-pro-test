---
title: Spellcheck
description: Detect misspelled words in the template text areas
---

<img src="/images/plugins/spellcheck-thumb.png" alt="" className="gif-border" style={{maxWidth: '552px'}} />
